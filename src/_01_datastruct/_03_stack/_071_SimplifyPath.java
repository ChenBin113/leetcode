...
public class _071_SimplifyPath {
    ...
    public String simplifyPath(String path) {
        ...
        for (int i = 0; i < strings.length; i++) {
            //if (strings[i].equals("..") && !_01_datastruct.stack.isEmpty()) _01_datastruct.stack.pop();
            //if (!strings[i].equals("..") && !strings[i].equals(".") && !strings[i].equals("")) _01_datastruct.stack.push(strings[i]);
            switch (strings[i]) {
                case "..":
                    if (!stack.isEmpty()) {
                        stack.pop();
